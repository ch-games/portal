...
<html>
<head>
    <title>提款 - 个人中心 - 体育彩票 | 福利彩票 | 中国体育彩票 - 趣彩网(触屏版)</title>
...
<div>
 <div style="border-right: medium none; border-left: medium none;" class="recharge1 recharge2">
    ...
    <link href="css/member.css" rel="stylesheet" type="text/css" />        <form action="/member/authrealname" method="post" onsubmit="return checkInput();">
    <div>
        ...
        <div class="record_import divColor">
            ...
            <input class="input_width" id="idCardNumber" name="idCardNumber" size="26" maxlength="18" placeholder="请输入身份证号"
                type="tel" />
        </div>
        <div class="record_import divColor">
            <span class="reminder">重复输入</span>
            <input class="input_width" id="idCardNumber2" name="idCardNumber2" placeholder="请输入身份证号" type="tel" size="26"
                maxlength="18" />
        </div>
        <br />
        <br />
