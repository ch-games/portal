...
<style>
.moreHeader h1{color:#FFF;background:#CD0508}
</style>
...
<header class="moreHeader">
        ...
        <a href="javascript:;" id="option"><h1 id="h1">红包明细</h1></a>
</header>
    <div class="classify divColor" id="juniorrebate">
        <table class="list">
            <tr>
                <td>
                    序号
...
<tr>
            ...
            <a class="betorder_Number_Selected">1</a>
