...
<header class="tzHeader">
    ...
    <div style=" background-color:#ffffff; border-bottom:1px solid #ffffff;height: 5rem;margin-top: -2rem;">
        ...
        <p class="progressTxt pdTop03">
              <span>发起 </span><cite>出票成功</cite><o>开奖</o><i>派奖</i>
        </p>
    </div>
        <a id="authority_1" class="hmTxt mgTop06 hmTxt2 clearfix" href="../tzdetails?SchemeId=TSM0417233307331224196075" onclick=" return Checkstate()">
            <span class="left">投注内容</span>
            <cite class="right black">截止公开</cite>
            <em class="hmArrow"></em>
        </a>
        <a class="hmTxt hmTxt2 clearfix" href="../hmjoin/TSM0417233307331224196075" onclick=" return CheckLogin_()">
            <span class="left">跟单用户</span>
            <cite id="views" class="yellow right">48人</cite>
            <em class="hmArrow"></em>
        </a>
        <a class="hmTxt hmTxt2" href="../mysubscribe?SchemeId=TSM0417233307331224196075"  onclick=" return CheckLogin_()">
        我的认购
            <em class="hmArrow"></em>
        </a>
        ...
        <div id="cdesc" class="hmTxt gray mgTop06">方案宣言:足彩大富翁为国内顶尖彩票高手，对国内外彩票深有研究，在足彩、竞彩、北京单场均取得不俗的战绩。足彩大富翁自有彩票研究室，由多年投身彩市，股市，期货，黄金，外汇等多个投资交易品种的资深专业人士精心组合而成，24小时不间断轮班分析和做单，请跟单的彩民朋友根据自身的状况进行理性的分散跟单，控制好跟单比例和节</div>
       
    </div>
</section>
    <footer style="" class="buyFooter">
        <div class="fixed buyFloat">
        <span class="left pdLeft06">认购<input type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" value="1" id="txt_TSM0417233307331224196075" class="hmbuyInput">元</span> 
        <input type="hidden" id="price_TSM0417233307331224196075" value="1.0000" />
        <a id="iPay" class="ture" onclick="CheckLogin('TSM0417233307331224196075',false)" href="javascript:;">购买</a>
        </div>
</footer>
